...
class ErrorHandlerTest extends TestCase
{
    ...
    public function testHandleError()
    {
        try {
            ...
            $warnArgCheck = function ($logLevel, $message, $context) {
                ...
                $this->assertEquals('UserOld Deprecated: foo', $message);
                $this->assertArrayHasKey('exception', $context);
                $exception = $context['exception'];
                $this->assertInstanceOf(\ErrorException::class, $exception);
                $this->assertSame('UserOld Deprecated: foo', $exception->getMessage());
    ...
    public function testHandleDeprecation()
    {
        $logArgCheck = function ($level, $message, $context) {
            ...
            $exception = $context['exception'];
            $this->assertInstanceOf(\ErrorException::class, $exception);
            $this->assertSame('UserOld Deprecated: Foo deprecation', $exception->getMessage());
        };
        ...
        try {
            ...
            $logger
                ...
                ->withConsecutive(
                    ...
                    array($this->equalTo(LogLevel::DEBUG), $this->equalTo('UserOld Warning: Silenced warning'))
                )
            ;
