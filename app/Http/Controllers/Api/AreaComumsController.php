...
class AreaComumsController extends Controller
{
     ...
     *
     * @param  AreaComumCreateRequest $request
     *
     * @return \Illuminate\Http\Response
     */
    public function store(AreaComumCreateRequest $request)
    {

        $areComum = $this->repository->create($request->all());
        return response()->json($areComum, 201);
    }
     ...
     *
     * @param  AreaComumUpdateRequest $request
     * @param  string            $id
     *
     * @return Response
     */
