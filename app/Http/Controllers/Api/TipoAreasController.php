...
class TipoAreasController extends Controller
{
     ...
     *
     * @param  TipoAreaCreateRequest $request
     *
     * @return \Illuminate\Http\Response
     */
    public function store(TipoAreaCreateRequest $request)
    {
     ...
     *
     * @param  TipoAreaUpdateRequest $request
     * @param  string            $id
     *
     * @return Response
     */
    public function update(TipoAreaUpdateRequest $request, $id)
    {
